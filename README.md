...
**Sitio:** https://oscarmdiazb.github.io/reservas-clima-aula-seguimiento-2026/ *(al habilitar GitHub Pages)*
...
| **Confirmación de listas** | **Nueva página `confirmacion.html`**: el colegio confirma qué estudiantes de su lista siguen y en qué curso están. Ver abajo |
| Backend | Despliegue **nuevo** de Apps Script sobre una Sheet **nueva** — no reutilizar la de R3 |

## Confirmación de listas (`confirmacion.html`)

Cada colegio recibe en su correo un enlace personal:
```
https://…/confirmacion.html?d=<DANE14>&c=<CÓDIGO>
```
...
5. Pegar la URL en `APPS_SCRIPT_URL` de **`index.html` y `confirmacion.html`** (dos archivos).
